...
class AdminController extends Controller
{
  ...
  public function getAllPackages()
  {
    $allpackages = $this->adminService->getAllPackages();
  ...
  public function getPackage($id)
  {
    $package = $this->adminService->getPackage($id);
  ...
  public function payByPoint($id)
  {
    $package = $this->adminService->togglePayByPoint($id);
  ...
  public function filterUsers(AdminRequest $request)
  {
    $users = $this->adminService->filterUsers($request->name);
  ...
  public function filter_sub_admins(AdminRequest $request)
  {
    $users = $this->adminService->filterSubAdmins($request->name);
  ...
  public function createSubAdmin($id)
  {
    $user = $this->adminService->createSubAdmin($id);
  ...
  public function getAllSubAdmin()
  {
    $subAdmins = $this->adminService->getAllSubAdmins();
  ...
  public function removeSubAdmin($id)
  {
    $user = $this->adminService->removeSubAdmin($id);
  ...
  public function getAllActivity()
  {
    $activities = $this->adminService->getAllActivity();
  ...
  public function addActivity(AdminRequest $request)
  {
    $result = $this->adminService->addActivity($request->name);
  ...
  public function deleteactivity($id)
  {
    $deleted = $this->adminService->deleteActivity($id);
  ...
  public function addcatigory(AdminRequest $request)
  {
    $result = $this->adminService->addCategory($request->name);
